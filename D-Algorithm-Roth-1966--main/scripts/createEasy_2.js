...
function solve_path_byStudent() {
    ...
    } else if(blac.value != "_" && blab.value == "_"){
        error_message_collection(7);
    }
    ...
    if((blad.value != bla_d.value) && (blab.value != bla_b.value)) {
        bla_c.value = "Input"
    }
    ...
    if((bla_a.value == "0") && (bla_d.value == "0")) {
        bla_e.value = "1";
    } else if ((bla_a.value == "0") && (bla_d.value == "1")) {
        bla_e.value = "1";
    } else if((bla_a.value == "0") && (bla_d.value == "D")) {
        bla_e.value = "1";
    } else if ((bla_a.value == "0") && (bla_d.value == "D'")) {
        bla_e.value = "1";

    } else if((bla_a.value == "1") && (bla_d.value == "0")) {
        bla_e.value = "1";
    } else if ((bla_a.value == "1") && (bla_d.value == "1")) {
        bla_e.value = "0";
    } else if((bla_a.value == "1") && (bla_d.value == "D")) {
        bla_e.value = "D'";
    } else if ((bla_a.value == "1") && (bla_d.value == "D'")) {
        bla_e.value = "D";

    } else if((bla_a.value == "D") && (bla_d.value == "0")) {
        bla_e.value = "1";
    } else if((bla_a.value == "D") && (bla_d.value == "1")) {
        bla_e.value = "D'";
    } else if ((bla_a.value == "D") && (bla_d.value == "D")) {
        bla_e.value = "D'"; 
    } else if((bla_a.value == "D") && (bla_d.value == "D'")) {
        bla_e.value = "1";
    ...
    if(blae.value != "_"){
        if((bla_e.value == "0") && (bla_f.value == "0")) {
            bla_out.value = "1";
            error_message_collection(4);
        } else if ((bla_e.value == "0") && (bla_f.value == "1")) {
            bla_out.value = "1";
            error_message_collection(4);
        } else if((bla_e.value == "0") && (bla_f.value == "D")) {
            bla_out.value = "1";
            error_message_collection(4);
        } else if ((bla_e.value == "0") && (bla_f.value == "D'")) {
            bla_out.value = "1";
        ...
        } else if((bla_e.value == "1") && (bla_f.value == "0")) {
            bla_out.value = "1";
            error_message_collection(4);
        } else if ((bla_e.value == "1") && (bla_f.value == "1")) {
            bla_out.value = "0";
            error_message_collection(4);
        } else if((bla_e.value == "1") && (bla_f.value == "D")) {
            bla_out.value = "D'";
        } else if ((bla_e.value == "1") && (bla_f.value == "D'")) {
            bla_out.value = "D";
    
    
        } else if((bla_e.value == "D") && (bla_f.value == "0")) {
            bla_out.value = "1";
            error_message_collection(4);
        } else if((bla_e.value == "D") && (bla_f.value == "1")) {
            bla_out.value = "D'";
        } else if ((bla_e.value == "D") && (bla_f.value == "D")) {
            bla_out.value = "D'";
        } else if((bla_e.value == "D") && (bla_f.value == "D'")) {
            bla_out.value = "1";
            error_message_collection(4);
...
function  get_Color_Correction() {
    ...
    // Input C is available if Students sets C and D values
     if(blab.value != "_" && blaf.value != "_" && blac.value != "_"){
    ...
    if(blae.value != "_" && blaout.value != "_" && blad.value != "_"){
    ...
    // declare Output F
    if(blaf.value != "_" && blae.value != "_" && blaout.value != "_" && blad.value != "_"){
        if(bla_f.value != blaf.value) {
            ...
            ctx7.fillRect(11, 26, 113, 8);
            ctx7.fillRect(11, 26, 8, 23);
...
function give_one_solution() {
    ...
    if(hints < 6) {  
        ...
        if (bla_d.value == undefined) {
            ...
            alert("The value of E is currently "+bla_e.value+". It depends on the inputs of A and D.");    
        }
        else if((blaout.value != bla_out.value) || bla_out.value == "1" || bla_out.value == "0") {
            alert("The output of the circuit must be set to D or D'. It depends on the inputs. The currently value is "+bla_out.value+".");    
        }
        else if(blaf.value != bla_f.value) {
            alert("This must be set to 0 or 1. It depends on the inputs B and C. The currently value is "+bla_f.value+".");
        }
